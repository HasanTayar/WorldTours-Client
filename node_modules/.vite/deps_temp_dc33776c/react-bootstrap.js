...
import {
  ...
  useBootstrapPrefix,
  useIsRTL
} from "./chunk-KNMZ7VUB.js";
import {
  init_react_lifecycles_compat_es
} from "./chunk-FFN2MPPG.js";
import {
  require_warning
...
function useMounted() {
  var mounted = (0, import_react19.useRef)(true);
  var isMounted = (0, import_react19.useRef)(function() {
...
function createWithBsPrefix(prefix, {
  ...
  const BsComponent = React17.forwardRef(({
    className,
    bsPrefix,
...
var Button2 = React22.forwardRef(({
  as,
  bsPrefix,
  variant = "primary",
  size: size2,
...
var CardImg = React25.forwardRef(
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  ({
    bsPrefix,
    className,
...
function useUpdateEffect(fn, deps) {
  var isFirst = (0, import_react26.useRef)(true);
...
function useUpdatedRef(value) {
  var valueRef = (0, import_react27.useRef)(value);
...
function useTimeout() {
  ...
  var handleRef = (0, import_react29.useRef)();
...
function useSafeState(state) {
  var isMounted = useMounted();
  return [state[0], (0, import_react32.useCallback)(function(nextState) {
    if (!isMounted())
      return;
...
function usePopper(referenceElement, popperElement, _ref = {}) {
  ...
  const prevModifiers = (0, import_react33.useRef)(modifiers);
  const popperInstanceRef = (0, import_react33.useRef)();
  const update = (0, import_react33.useCallback)(() => {
    var _popperInstanceRef$cu;
    (_popperInstanceRef$cu = popperInstanceRef.current) == null ? void 0 : _popperInstanceRef$cu.update();
  }, []);
  const forceUpdate = (0, import_react33.useCallback)(() => {
    var _popperInstanceRef$cu2;
    (_popperInstanceRef$cu2 = popperInstanceRef.current) == null ? void 0 : _popperInstanceRef$cu2.forceUpdate();
  }, []);
  const [popperState, setState] = useSafeState_default((0, import_react33.useState)({
    placement,
    update,
    forceUpdate,
    attributes: {},
  ...
  const updateModifier = (0, import_react33.useMemo)(() => ({
  ...
  const nextModifiers = (0, import_react33.useMemo)(() => {
...
function useClickOutside(ref, onClickOutside = noop, {
  ...
  const preventMouseClickOutsideRef = (0, import_react34.useRef)(false);
  const waitingForTrigger = (0, import_react34.useRef)(false);
  const handleMouseCapture = (0, import_react34.useCallback)((e) => {
...
function useDropdownMenu(options = {}) {
  const context6 = (0, import_react35.useContext)(DropdownContext_default);
...
var $704cf1d3b684cc5c$var$SSRContext = (0, import_react36.default).createContext($704cf1d3b684cc5c$var$defaultContext);
function $704cf1d3b684cc5c$export$9f8ac96af4b1b2ae(props) {
  let cur = (0, import_react36.useContext)($704cf1d3b684cc5c$var$SSRContext);
  let counter = $704cf1d3b684cc5c$var$useCounter(cur === $704cf1d3b684cc5c$var$defaultContext);
  let [isSSR, setIsSSR] = (0, import_react36.useState)(true);
  let value = (0, import_react36.useMemo)(() => ({
  ...
  return (0, import_react36.default).createElement($704cf1d3b684cc5c$var$SSRContext.Provider, {
    value
  }, props.children);
}
...
function $704cf1d3b684cc5c$var$useCounter(isDisabled = false) {
  let ctx = (0, import_react36.useContext)($704cf1d3b684cc5c$var$SSRContext);
...
var Context = (0, import_react39.createContext)(canUseDOM_default ? window : void 0);
...
function Dropdown({
  ...
  const context6 = (0, import_react40.useMemo)(() => ({
    toggle,
    placement,
    show,
    menuElement,
...
function useWrappedRefWithWarning(ref, componentName) {
  if (false)
    return ref;
  const warningRef = (0, import_react41.useCallback)((refValue) => {
...
var DropdownMenu2 = React44.forwardRef(({
  ...
  let alignEnd = false;
  const isNavbar = (0, import_react42.useContext)(NavbarContext_default);
  const prefix = useBootstrapPrefix(bsPrefix, "dropdown-menu");
  const {
    align: contextAlign,
    drop,
    isRTL
  } = (0, import_react42.useContext)(DropdownContext_default2);
...
var DropdownToggle2 = React45.forwardRef(({
  ...
  const dropdownContext = (0, import_react43.useContext)(DropdownContext_default);
...
var Feedback = React48.forwardRef(
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  ({
    as: Component2 = "div",
    className,
...
var FormContext = React49.createContext({});
var FormContext_default = FormContext;

// node_modules/react-bootstrap/esm/FormCheckInput.js
var import_jsx_runtime44 = __toESM(require_jsx_runtime());
var FormCheckInput = React50.forwardRef(({
  id,
  bsPrefix,
  className,
  type = "checkbox",
...
var FormCheckLabel = React51.forwardRef(({
  bsPrefix,
  className,
  htmlFor,
  ...props
...
var FormCheck = React52.forwardRef(({
  id,
  bsPrefix,
  bsSwitchPrefix,
  inline = false,
  ...
  const innerFormContext = (0, import_react47.useMemo)(() => ({
...
var FormGroup = React54.forwardRef(({
  controlId,
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  as: Component2 = "div",
  ...props
}, ref) => {
  const context6 = (0, import_react49.useMemo)(() => ({
    controlId
  }), [controlId]);
...
var FormLabel = React55.forwardRef(({
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  as: Component2 = "label",
  bsPrefix,
  column = false,
...
var FormRange = React56.forwardRef(({
  bsPrefix,
  className,
  id,
  ...props
...
var FormSelect = React57.forwardRef(({
  bsPrefix,
  size: size2,
  htmlSize,
  className,
...
var FormText = React58.forwardRef(
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  ({
    bsPrefix,
    className,
...
var Switch = React59.forwardRef((props, ref) => (0, import_jsx_runtime55.jsx)(FormCheck_default, {
  ...props,
  ref,
  type: "switch"
}));
...
var FloatingLabel = React60.forwardRef(({
  bsPrefix,
  className,
  children,
  controlId,
...
var FigureImage = React64.forwardRef(({
  ...
  fluid = true,
  ...props
}, ref) => (0, import_jsx_runtime61.jsx)(Image_default, {
  ref,
  ...props,
  fluid,
...
var InputGroupCheckbox = (props) => (0, import_jsx_runtime62.jsx)(InputGroupText, {
  children: (0, import_jsx_runtime62.jsx)(FormCheckInput_default, {
    type: "checkbox",
    ...props
  })
});
var InputGroupRadio = (props) => (0, import_jsx_runtime62.jsx)(InputGroupText, {
  children: (0, import_jsx_runtime62.jsx)(FormCheckInput_default, {
    type: "radio",
    ...props
  })
...
function useWaitForDOMRef(ref, onResolved) {
  const window2 = useWindow();
  const [resolvedRef, setRef] = (0, import_react56.useState)(() => resolveContainerRef(ref, window2 == null ? void 0 : window2.document));
  if (!resolvedRef) {
...
function NoopTransition({
  ...
  const child = (0, import_react57.cloneElement)(children, {
    ref: combinedRef
  });
  if (inProp)
    return child;
...
function renderTransition(Component2, runTransition, props) {
  if (Component2) {
    return (0, import_jsx_runtime67.jsx)(Component2, Object.assign({}, props));
  }
  if (runTransition) {
...
var AbstractModalHeader = React75.forwardRef(({
  ...
  const context6 = (0, import_react60.useContext)(ModalContext_default);
...
var Modal2 = React77.forwardRef(({
  ...
  const renderBackdrop = (0, import_react61.useCallback)((backdropProps) => (0, import_jsx_runtime75.jsx)("div", {
    ...backdropProps,
...
function createBreakpointHook(breakpointValues) {
  ...
  function useBreakpoint2(breakpointOrMap, direction, window2) {
    ...
    var query = (0, import_react66.useMemo)(function() {
...
var Offcanvas = React85.forwardRef(({
  ...
  const renderBackdrop = (0, import_react67.useCallback)((backdropProps) => (0, import_jsx_runtime83.jsx)("div", {
    ...backdropProps,
...
var Popover = React91.forwardRef(({
  ...
  return (0, import_jsx_runtime91.jsxs)("div", {
    ...
    children: [(0, import_jsx_runtime90.jsx)("div", {
      ...
      ...arrowProps
    }), body ? (0, import_jsx_runtime90.jsx)(PopoverBody_default, {
      children
    }) : children]
  });
});
...
function OverlayTrigger({
  ...
  return (0, import_jsx_runtime95.jsxs)(import_jsx_runtime94.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react74.cloneElement)(children, triggerProps), (0, import_jsx_runtime93.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip,
...
var SplitButton = React101.forwardRef(({
  id,
  bsPrefix,
  size: size2,
  variant,
  ...
  flip,
  ...props
}, ref) => (0, import_jsx_runtime105.jsxs)(Dropdown_default2, {
  ref,
  ...props,
...
var Stack = React102.forwardRef(({
  ...
  return (0, import_jsx_runtime106.jsx)(Component2, {
    ...props,
    ref,
    className: (0, import_classnames66.default)(className, bsPrefix, ...createUtilityClassName({
      gap
...
var TabPanel = React103.forwardRef(
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  (_ref2, ref) => {
    let {
      as: Component2 = "div"
...
var TabContainer = ({
  transition,
  ...props
}) => (0, import_jsx_runtime109.jsx)(Tabs_default, {
  ...props,
...
var TabPane = React106.forwardRef(({
  bsPrefix,
  transition,
  ...props
}, ref) => {
    ...
    children: (0, import_jsx_runtime110.jsx)(SelectableContext_default.Provider, {
      ...
      children: (0, import_jsx_runtime110.jsx)(Transition, {
        ...
        children: (0, import_jsx_runtime110.jsx)(Component2, {
          ...rest,
          ref,
          className: (0, import_classnames67.default)(className, prefix, isActive && "active")
        })
      })
    })
  });
...
var Table = React108.forwardRef(({
  ...
  const classes = (0, import_classnames68.default)(className, decoratedBsPrefix, variant && `${decoratedBsPrefix}-${variant}`, size2 && `${decoratedBsPrefix}-${size2}`, striped && `${decoratedBsPrefix}-${typeof striped === "string" ? `striped-${striped}` : "striped"}`, bordered && `${decoratedBsPrefix}-bordered`, borderless && `${decoratedBsPrefix}-borderless`, hover && `${decoratedBsPrefix}-hover`);
  const table = (0, import_jsx_runtime113.jsx)("table", {
    ...props,
    className: classes,
    ref
  });
...
function renderTab(child) {
  ...
  return (0, import_jsx_runtime114.jsx)(NavItem_default2, {
    as: "li",
    role: "presentation",
    children: (0, import_jsx_runtime114.jsx)(NavLink_default, {
      as: "button",
      type: "button",
      eventKey,
      disabled,
...
var Tabs2 = (props) => {
  ...
  return (0, import_jsx_runtime115.jsxs)(Tabs_default, {
    ...
    mountOnEnter,
    unmountOnExit,
    children: [(0, import_jsx_runtime114.jsx)(Nav_default2, {
      ...controlledProps,
      role: "tablist",
      as: "ul",
      variant,
      ...
      children: map(children, (child) => {
        ...
        return (0, import_jsx_runtime114.jsx)(TabPane_default, {
          ...childProps
        });
      })
    })]
...
var ToastFade = React110.forwardRef((props, ref) => (0, import_jsx_runtime116.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastHeader = React112.forwardRef(({
  ...
  return (0, import_jsx_runtime118.jsxs)("div", {
    ref,
    ...props,
    className: (0, import_classnames69.default)(bsPrefix, className),
...
var ToastContainer = React114.forwardRef(({
  bsPrefix,
  position,
  containerPosition,
  className,
...
var noop6 = () => void 0;
var ToggleButton = React115.forwardRef(({
  bsPrefix,
  name,
  className,
  checked,
...
var ToggleButtonGroup = React116.forwardRef((props, ref) => {
  const {
    children,
    type = "radio",
    name,
...
var Tooltip = React117.forwardRef(({
  bsPrefix,
  placement = "right",
  className,
  style: style2,
